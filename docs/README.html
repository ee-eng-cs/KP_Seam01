...
<UL>
  <LI/>Manage departments and its employees (<B>C</B>reate, <B>R</B>ead, <B>U</B>pdate, <B>D</B>elete)
...
Application was build with <B>Java 8</B> and tested with <B>JBoss EAP 7.1</B> and <B>WildFly 11.0</B>.<BR/>
Application URL: <A href="http://localhost:8080/KP_Seam01/" ><B>http://localhost:8080/KP_Seam01/</B></A>.<BR/>
</P>
...
<P>
The application uses <B>JavaServer Faces</B> web application framework.<BR/>
<UL>
...
<P>
JAX-RS is activated with "no XML" approach by subclassing "javax.ws.rs.core.Application" and annotating code with @ApplicationPath.<BR/>
...
XML Web Services Client. Displayed query result in the table "Employees".</P>
<P><BR/><IMG src="images/JAX-RS.jpg"/><BR/>
RESTful Web Services Client. On this page there are links to the REST endpoints.</P>
<HR/>
<I>The application architecture is based on Maven archetype: "kitchensink" example from JBoss AS 7 Quickstart examples.</I>
